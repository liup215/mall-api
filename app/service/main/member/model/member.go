...
type EweiShopMember struct {
	...
	Agenttime           int     `json:"agenttime,omitempty"`
	...
	Childtime           int     `json:"childtime,omitempty"`
	...
	Endtime2            int     `json:"endtime2,omitempty"`
	...
	Aagenttime          int     `json:"aagenttime,omitempty"`
	...
	Authortime          int     `json:"authortime,omitempty"`
	...
	Wxcardupdatetime    int     `json:"wxcardupdatetime,omitempty"`
}
